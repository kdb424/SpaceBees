...
public class HiveGenMoon implements IHiveGen
{
	...
	public HiveGenMoon(int minLevel, int range, int surroundCount) {
		this(minLevel, range, Blocks.stone, surroundCount);
	}

	public HiveGenMoon(int minLevel, int range, Block replace, int surroundCount)
	{
